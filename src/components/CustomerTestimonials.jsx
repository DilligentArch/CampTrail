  ...
  const testimonials = [
    {
      id: 1,
      name: "Fatema Begum",
      icon: <FaUserAlt className="text-pink-500 text-3xl" />,
      review: "The Bandarban Hills Camping Retreat was amazing! The guides were great, and the views were stunning.",
      rating: 5,
    },
    {
      id: 2,
      ...
      review: "I loved the eco-friendly initiatives and the peaceful campsite atmosphere. Highly recommended!",
      rating: 4,
    },
    {
      id: 3,
      name: "Shafiq Ahmed",
      icon: <FaUserTie className="text-blue-500 text-3xl" />,
      review: "Camping by the serene lake and stargazing was magical. I’ll definitely book again!",
      rating: 5,
    },
  ];
